...
if ($doPrint) {
    ...
    if ($pack === []) {
        ...
        echo '<div class="alert alert-info">No student found to print. <a href="' . e($listUrl) . '">Back</a></div>';
...
<?php else: ?>
  ...
  <?php else: ?>
    <div class="mb-3 d-flex flex-wrap gap-2">
      <a class="btn btn-success" href="<?php echo e($qs($classId)); ?>&amp;print=1" target="_blank">Print class (<?php echo count($students); ?>)</a>
    </div>
    <?php foreach ($students as $s):
      ...
      <div class="idc-mini">
        ...
        <a class="btn btn-sm btn-outline-primary" href="<?php echo e($qs($classId, $sid)); ?>&amp;print=1" target="_blank">Print card</a>
      </div>
    <?php endforeach; ?>
  <?php endif; ?>
<?php endif; ?>
