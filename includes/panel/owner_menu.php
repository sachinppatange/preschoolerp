    ...
    return [
        ...
        [
            ...
            'items' => [
                ...
                ['url' => $owner . '/pending_notifications.php', 'icon' => 'bi-bell', 'label' => 'Staff reminders', 'match' => 'pending_notifications'],
            ],
        ],
        [
            'section' => 'Website CMS',
        ...
        [
            ...
            'items' => [
                ...
                ['url' => $owner . '/whatsapp.php', 'icon' => 'bi-whatsapp', 'label' => 'WhatsApp', 'match' => 'whatsapp'],
