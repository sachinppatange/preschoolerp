...
if ($parent_id > 0) {
    $parent = safe_db_get_one("SELECT id, name, phone, school_id FROM users WHERE id = :id AND role='parent' LIMIT 1", [':id'=>$parent_id]);
...
<div class="adm-page">
  ...
  <div class="panel-toolbar adm-toolbar">
    ...
    <div class="adm-toolbar-actions">
      ...
      <a href="add_parents.php" class="btn btn-sm btn-outline-secondary"><i class="bi bi-person-plus me-1"></i>Parents</a>
